...
//======================if user is logged in {}
  ...
  $users_counter = "SELECT * from courses";
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <a type="button" class="btn btn-primary" href = "course_add.php">Add</a>
        ...
        while($row = mysqli_fetch_array($res_data)){
                        ...
                        //$cat = $row['cat'];
                         ...
                         //Get club category name
                           $sql4 = "SELECT * FROM categories WHERE id = '$names'";
                       ...
                       //students counter
                        $events_counter = "SELECT * from students where course_id = '$id'";
