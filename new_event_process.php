...
?>
    <title>Event Processing | ALUSM</title>
  </head>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>New Event Processing <small></small></h2>
...
$datentime = mysqli_real_escape_string($conn, $datentime);
...
$sql = "INSERT INTO `events`(event_title, cat, location, event_date, description,club_id, admin_id, status)
                       VALUES('$event_name', '$category', '$location', '$datentime', '$description',0, '$userid', 'Active')";
