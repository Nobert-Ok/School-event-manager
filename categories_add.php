              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/nobs.jpeg" alt=""><?php echo $_SESSION['firstname'];?>
...
if($result){
    echo "<div class = 'alert alert-success'>Information updated successfully. <a href ='categories.php' class = 'btn btn-danger'>View Categories</a></div>";
}
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" placeholder="e.g ALU Nigeria" name = "category_name" required>
                        </div>
                      </div>
