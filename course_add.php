...
if($result){
    echo "<div class = 'alert alert-success'>Information updated successfully. <a href ='courses.php' class = 'btn btn-danger'>View Courses</a></div>";
}
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" placeholder="e.g Computer Science" name = "course_name" required>
                        </div>
                      </div>
